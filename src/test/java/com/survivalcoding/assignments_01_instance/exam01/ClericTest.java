...
class ClericTest {
    ...
    @Test
    @DisplayName("이름, HP, MP 를 지정하여 인스턴스화 할 수 있다")
    void testClericnew1() {
        //given
        Cleric cleric = new Cleric("아서스", 40, 5);

        // then
        assertEquals("아서스", cleric.name);  //이름은 아서스
        assertEquals(40, cleric.hp);   //hp = 40
        assertEquals(5, cleric.mp);   //mp = 5
    }

    @Test
    @DisplayName("이름, HP만 지정하여 인스턴스화 할 수 있다")
    void testClericnew2() {
        //given
        ...
        // then
        assertEquals("아서스", cleric.name);  //이름은 아서스
        assertEquals(35, cleric.hp);   //hp = 35
        assertEquals(10, cleric.mp);   //mp = 10
    }

    @Test
    @DisplayName("이름만 지정하여 인스턴스화 할 수 있다")
    void testClericnew3() {
        //given
        Cleric cleric = new Cleric("아서스");
        ...
        // then
        assertEquals("아서스", cleric.name);  //이름은 아서스
        assertEquals(Cleric.max_hp, cleric.hp);   //hp = 최대
        assertEquals(Cleric.max_mp, cleric.mp);   //mp = 최대
    }
